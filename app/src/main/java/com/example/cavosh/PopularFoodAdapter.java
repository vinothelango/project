...
public class PopularFoodAdapter extends RecyclerView.Adapter<PopularFoodAdapter.PopularFoodViewHolder> {
    ...
    public PopularFoodViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(context).inflate(R.layout.row_recommened, parent, false);
    ...
    public static final class PopularFoodViewHolder extends RecyclerView.ViewHolder {
        ...
        public PopularFoodViewHolder(@NonNull View itemView) {
            super(itemView);
            foodImage = itemView.findViewById(R.id.imgvertical);
            price = itemView.findViewById(R.id.imgvertical);
            name = itemView.findViewById(R.id.imgvertical);
